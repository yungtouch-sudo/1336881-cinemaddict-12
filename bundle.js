...
/* harmony default export */ __webpack_exports__["default"] = ({
  AUTHORIZATION: `Basic KJBjjakljaojs655hgat`,
  END_POINT: `https://12.ecmascript.pages.academy/cinemaddict/`,
  STORE_PREFIX: `cinemaadict-localstorage`,
  STORE_VER: `v12`,
});
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: UpdateType, FilterType, SortType, UserAction, MenuItem, Emotions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _model_movies_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/movies.js */ "./src/model/movies.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _presenter_profile_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/profile.js */ "./src/presenter/profile.js");
...
/* harmony import */ var _view_footer_statisctic_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view/footer-statisctic.js */ "./src/view/footer-statisctic.js");
/* harmony import */ var _view_statistics_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./view/statistics.js */ "./src/view/statistics.js");
/* harmony import */ var _api_index_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./api/index.js */ "./src/api/index.js");
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
...
const STORE_NAME = `${_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].STORE_PREFIX}-${_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].STORE_VER}`;

const siteMainElement = document.querySelector(`.main`);
const siteFooterElement = document.querySelector(`.footer`);
const siteHeaderElement = document.querySelector(`.header`);

const moviesModel = new _model_movies_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const filtersModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_4__["default"]();

const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_10__["default"](_config_js__WEBPACK_IMPORTED_MODULE_2__["default"].END_POINT, _config_js__WEBPACK_IMPORTED_MODULE_2__["default"].AUTHORIZATION);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_11__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_12__["default"](api, store);
...
const moviePresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_6__["default"](siteMainElement, moviesModel, filtersModel, apiWithProvider);
...
const handleMainMenuClick = (menuItem) => {
  ...
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER:
      currentMenuMode = menuItem;
      siteStatistic.destroy();
      moviePresenter.init();
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS:
      currentMenuMode = menuItem;
      siteStatistic = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_9__["default"](moviesModel.get(), siteMainElement);
...
let currentMenuMode = _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER;
...
apiWithProvider.getMovies().then((films) => {
  ...
  moviesModel.set(_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].INIT, films);
  filterPresenter.turnOnFilters();
  filterPresenter.setMenuClickHandler(handleMainMenuClick);
  const userProfilePresenter = new _presenter_profile_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteHeaderElement, moviesModel);
  userProfilePresenter.init();
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(siteFooterElement, new _view_footer_statisctic_js__WEBPACK_IMPORTED_MODULE_8__["default"](moviesModel.get().length), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
})
.catch(() => {
  moviesModel.set(_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].INIT, []);
});
...
class FilmPresenter {
  ...
  init(film) {
    ...
    this._filmPopupComponent = new _view_film_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](film);
...
class UserProfilePresenter {
  ...
  init() {
    ...
    this._userProfileComponent = new _view_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](countWatchedFilms);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._userProfileComponent, prevProfileComponent);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevProfileComponent);
  }
...
const createComments = (comments, deletingComment, isDisabled, isDeleting) => {
  ...
  for (let i = 0; i < comments.length; i++) {
    ...
    `<li class="film-details__comment">
      ...
      <img src="${_const_js__WEBPACK_IMPORTED_MODULE_2__["Emotions"][comments[i].emoji]}" width="55" height="55" alt="emoji-${comments[i].emoji}">
      </span>
      <div>
...
const createUserEmojiTemplate = (userEmoji) => {
  return userEmoji === `` ? `` : `<img src="${_const_js__WEBPACK_IMPORTED_MODULE_2__["Emotions"][userEmoji]}" width="55" height="55" alt="emoji-smile">`;
};
...
class FilmPopup extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  _createComment(emoji, text) {
    return {
      ...
      date: new Date(),
      emoji,
      img: _const_js__WEBPACK_IMPORTED_MODULE_3__["Emotions"][emoji],
    };
  }
