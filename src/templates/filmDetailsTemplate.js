export default ({title, ages, poster, original, rating, description, countries, year, duration, director, writers, actors, genre, isFavorite, isWatchList, isAllreadyWatched}) => {
